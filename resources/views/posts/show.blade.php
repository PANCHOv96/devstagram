                    ...
                    <form action="{{ route('comentarios.store', ['post' => $post , 'user' => $user] ) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea 
                                id="comentario"
                                name="comentario"
                                placeholder="Agrega un comantario"
                        ...
                        <input type="submit" value="Crear Publicacion" class="bg-sky-600 hover:bg-sky-700 trasition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg">
                    </form>
                @endauth
